...
this.props.sortprop(e.target.id)
e.preventDefault()
},

handleOrder:function(e){
  this.props.resort(e.target.id)
  e.preventDefault();
},

handleSearch:function(e){
this.props.search(e.target.value)//good way to getthe value you entered after event is triggered
},
